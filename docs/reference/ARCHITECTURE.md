...
| :--- | :--- | :--- |
| **Database** | PostgreSQL 16 + pgvector | Docker `docker-compose.yml` at **repo root** → host port **5433** |
...
* All modules share the same database instance running on port `5433` (Dockerized).
