...
export const MOCK_TASK_SUMMARY: TaskSummary = {
  totalTasksToday: 5,
  completedCount: 0,
  inProgressCount: 2,
  upcomingCount: 5,
...
export const MOCK_LOOKUP_RESULTS: LookupResult[] = [
...
export const MOCK_ASSIGNABLE_USERS: AssignableUser[] = [
...
export const MOCK_EMAIL_DRAFTS: Record<string, EmailDraft> = {
  'task-002': {
    taskId: 'task-002',
    contactName: 'Sarah Chen',
...
export const MOCK_LINKEDIN_DRAFTS: Record<string, LinkedInDraft> = {
  'task-005': {
    taskId: 'task-005',
    contactId: 'contact-006',
    contactName: 'Tom Anderson',
...
export const MOCK_CONTACT_DETAILS: Record<string, ContactDetails> = {
  'contact-001': {
    contactId: 'contact-001',
    contactName: 'Sarah Chen',
...
export const MOCK_ENGAGEMENT_TIMELINES: Record<string, EngagementTimelineEvent[]> = {
  'contact-001': [
    {
      eventId: 'evt-001',
...
export const MOCK_SMART_CALL_INITS: Record<string, SmartCallInit> = {
  'task-001': {
    taskId: 'task-001',
    contactName: 'Sarah Chen',
...
export const MOCK_LIVE_SESSION_DATA: LiveSessionData = {
