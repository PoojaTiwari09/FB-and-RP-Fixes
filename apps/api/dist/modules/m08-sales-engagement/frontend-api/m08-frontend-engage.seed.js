...
exports.MOCK_CALL_SUMMARY = exports.MOCK_LIVE_SESSION_DATA = exports.MOCK_SMART_CALL_INITS = exports.MOCK_FILTER_OPTIONS = exports.MOCK_CRM_FIELDS = exports.MOCK_ENGAGEMENT_TIMELINES = exports.MOCK_CONTACT_DETAILS = exports.MOCK_LINKEDIN_DRAFTS = exports.MOCK_EMAIL_TEMPLATES = exports.MOCK_EMAIL_DRAFTS = exports.MOCK_ASSIGNABLE_USERS = exports.MOCK_LOOKUP_RESULTS = exports.MOCK_TASK_DETAILS = exports.MOCK_RECENT_ACTIVITY = exports.MOCK_TASK_SUMMARY = exports.MOCK_TASKS = void 0;
exports.MOCK_TASKS = [
    {
        taskId: 'task-001',
...
exports.MOCK_ENGAGEMENT_TIMELINES = {
    'contact-001': [
        {
            eventId: 'evt-001',
...
exports.MOCK_SMART_CALL_INITS = {
    'task-001': {
        taskId: 'task-001',
        contactName: 'Sarah Chen',
        contactCompany: 'Acme Corp',
        supportedIntegrations: ['ZOOM', 'MEET', 'TEAMS'],
        preCallBriefing: 'Sarah is VP of Sales Operations at Acme Corp ($240K ARR, Negotiation stage). She opened your last email 4x and visited the pricing page twice. Budget is approved — needs CFO sign-off. Lead with ROI and push for a close date of June 30.',
    },
    'task-002': {
        taskId: 'task-002',
        contactName: 'Sarah Chen',
        contactCompany: 'Acme Corp',
        supportedIntegrations: ['ZOOM', 'MEET', 'TEAMS'],
        preCallBriefing: 'Step 2 follow-up with Sarah at Acme Corp. Reference her pain points from the May 24 discovery call: manual renewal tracking and no real-time risk visibility. Use the demo recording as a conversation anchor.',
    },
    'task-003': {
        taskId: 'task-003',
        contactName: 'Michael Rodriguez',
        contactCompany: 'TechFlow Inc',
        supportedIntegrations: ['ZOOM', 'MEET', 'TEAMS'],
        preCallBriefing: 'Michael is VP of Engineering at TechFlow Inc ($180K ARR, Evaluation). He requested security docs — lead with SOC 2 Type II and ISO 27001 compliance. Have your SE on standby for a technical deep-dive if needed.',
    },
};
exports.MOCK_LIVE_SESSION_DATA = {
    ...
    competitorIntelligence: {
        ...
        sayThis: 'I understand you looked at Gong previously. Where we differ is in the total cost — most teams our size save 40% annually with us while getting the same core intelligence capabilities.',
    },
    intentSignals: [
    ...
    conversationSummary: 'Rep opened with rapport building. Customer raised concerns about data migration complexity. Rep addressed with SLA commitment. Currently in pricing discussion.',
};
exports.MOCK_CALL_SUMMARY = {
...
//# sourceMappingURL=m08-frontend-engage.seed.js.map