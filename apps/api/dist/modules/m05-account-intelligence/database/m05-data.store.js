...
exports.m05DataStore = exports.M05DataStore = exports.M05_TAB_FILTERS = void 0;
exports.m05SeedManifest = m05SeedManifest;
...
exports.M05_TAB_FILTERS = {
    all: { operator: 'AND', conditions: [] },
    highArr: {
        operator: 'AND',
    ...
    return [
        {
            ...
            label: 'All Accounts',
            is_default: true,
            filter_logic: exports.M05_TAB_FILTERS.all,
            order: 0,
        },
        {
            tab_id: 2,
            ...
            label: 'High ARR',
            is_default: false,
            filter_logic: exports.M05_TAB_FILTERS.highArr,
            order: 1,
        },
        {
            tab_id: 3,
            ...
            label: 'At Risk',
            is_default: false,
            filter_logic: exports.M05_TAB_FILTERS.atRisk,
            order: 2,
        },
    ];
}
function buildActivities() {
    const acts = [
        {
            ...
            local_id: (0, crypto_1.randomUUID)(),
    ...
    const acmeTypes = ['CALL', 'EMAIL', 'CALL', 'MEETING', 'EMAIL', 'CALL', 'EMAIL', 'CALL'];
...
exports.M05DataStore = M05DataStore;
exports.m05DataStore = new M05DataStore();
//# sourceMappingURL=m05-data.store.js.map