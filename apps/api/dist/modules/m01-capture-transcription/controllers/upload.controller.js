...
let UploadController = class UploadController {
    ...
    async uploadAudio(file, req) {
        ...
        if (!ALLOWED_AUDIO.includes(file.mimetype)) {
            throw new common_1.BadRequestException(`Unsupported audio format: ${file.mimetype}. Accepted: MP3, WAV, OGG, M4A, FLAC, AAC`);
        }
        ...
        const title = rawName
            ...
            .trim() || 'Uploaded Call';
        const audioUrl = (0, upload_paths_1.getPublicAudioUrl)(file.filename);
