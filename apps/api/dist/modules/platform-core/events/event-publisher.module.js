...
const platform_events_worker_1 = require("./platform-events.worker");
...
exports.EventPublisherModule = EventPublisherModule = __decorate([
    ...
    (0, common_1.Module)({
        ...
        providers: [event_publisher_service_1.EventPublisherService, platform_events_worker_1.PlatformEventsWorker],
