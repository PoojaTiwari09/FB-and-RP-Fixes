...
export function mockFetchTaskDetailResponse(task: Task) {
  return {
    status: 'success',
    data: task,
  };
...
export function mockCreateTaskApiResponse(task: Task) {
  return {
    status: 'success',
    data: {
      taskId: task.id,
...
export function mockReassignTaskApiResponse(task: Task) {
  return {
    status: 'success',
    data: {
      taskId: task.id,
