...
import { fetchBoards, updateBoard, triggerSync } from '@/lib/api';
...
export default function AdminPage() {
  ...
  const handleSave = async () => {
    ...
    setSaveMsg('');
    try {
      await updateBoard(selectedBoard.slug, {
            ...
            <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                <button
                  ...
                  disabled={saving}
                >
                  {saving ? 'Saving…' : 'Save Board Config'}
                </button>
                <a href="/board/commercial" className="btn btn-secondary">
                  ← Back to Dashboard
                </a>
                {saveMsg && (
                  <span style={{
