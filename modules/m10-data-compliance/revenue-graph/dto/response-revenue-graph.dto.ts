// M10 Revenue Graph — Response DTOs
// Owned by: modules/m10-data-compliance/ (TDD Doc #11a v3.0)
// These shape the JSON responses from controller to API consumers.
// Downstream modules (M2, M4, M5, M6, M7) depend on these contracts.
