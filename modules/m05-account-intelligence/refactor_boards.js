...
const fileContent = `import { Injectable, NotFoundException, BadRequestException } from '@nestjs/common';
...
export class BoardsService {
  ...
  async updateColumn(slug: string, colId: string, updates: any) {
    ...
    const realColId = \`\${board.board_id}_\${colId}\`;
...
fs.writeFileSync(path.join(__dirname, 'services', 'boards.service.ts'), fileContent);
console.log('Refactored boards.service.ts');
