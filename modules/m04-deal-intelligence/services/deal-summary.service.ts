...
import { DealSummary, Deal, AuditAction, AuditEntityType } from '@m04/entities';
...
Do not wrap it in markdown code blocks or add any comments or text. Return strictly the JSON object.`;
    ...
    // Create new summary or update existing
    ...
    summary.nextSteps = generatedData.commitments.map((c: any) => c.description);
