...
**HubSpot live data:** set `HUBSPOT_ACCESS_TOKEN` + `HUBSPOT_PORTAL_ID` in `.env`, restart API, role **admin** → **Sync now** in UI. See `INTEGRATION-M05.md`.
...
| Module | File |
|--------|------|
| M01 + M02 | `INTEGRATION-M01-M02.md` |
| M03 | `INTEGRATION-M03.md` |
| M05 | `INTEGRATION-M05.md`, `M05-VERIFICATION.md` |
| M09 | `INTEGRATION-M09.md` |
| M10 | `INTEGRATION-M10.md` |
