...
import styles from "./AskAnythingSidebar.module.css";
    ...
    <aside className={styles.sidebar}>
      ...
      <div className={styles.brand}>
        <div className={styles.logo}>
          <svg viewBox="0 0 24 24" fill="none" width="20" height="20">
            ...
            <path d="M2 17l10 5 10-5M2 12l10 5 10-5" stroke="#2563eb" strokeWidth="1.5" strokeLinejoin="round"/>
          </svg>
      ...
      <div className={styles.newChatWrapper}>
        <button className={styles.newChatBtn} onClick={onNewChat}>
          <svg viewBox="0 0 24 24" fill="none" width="14" height="14" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
