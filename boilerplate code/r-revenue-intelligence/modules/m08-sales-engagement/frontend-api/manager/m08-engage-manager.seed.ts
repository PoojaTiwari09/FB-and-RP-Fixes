/** Manager Engage demo seed — aligned with Revenue-Intelligence-UI-engage-manager mocks. */
...
export const MOCK_RECENT_ACTIVITY = [
  ...
  },
  {
    ...
    activityType: 'linkedin_profile_viewed' as const,
...
// API-style mock response helpers representing backend server contracts
export function mockFetchTasksResponse(
  groups: { groupLabel: string; count: number; tasks: Record<string, unknown>[] }[],
...
export function mockFetchSummaryResponse(summary: any) {
  return {
    status: 'success',
    data: summary,
  };
...
export function mockFetchTaskDetailResponse(task: Record<string, unknown>) {
  return {
    status: 'success',
    data: task,
  };
...
export function mockFetchRecentActivityResponse(activities: any[]) {
  return {
    status: 'success',
    data: activities,
  };
...
export function mockCreateTaskApiResponse(task: Record<string, unknown>) {
  return {
    status: 'success',
    data: {
      taskId: task.id,
...
export function mockReassignTaskApiResponse(task: Record<string, unknown>) {
  return {
    status: 'success',
    data: {
      taskId: task.id,
...
export function mockSkipTaskResponse(taskId: string) {
  return {
    status: 'success',
    data: {
      taskId,
...
export function mockDismissTaskResponse(taskId: string) {
  return {
    status: 'success',
    data: {
      taskId,
...
export function mockActionResponse(taskId: string, action: string) {
  return {
    status: 'success',
    data: {
      taskId,
...
export function mockSearchLinkedEntitiesResponse(results: any[]) {
  return {
    status: 'success',
    data: {
      results,
...
export function mockFetchEmailDraftResponse(emailDraft: any) {
  return {
    status: 'success',
    data: emailDraft,
  };
...
export function mockFetchLinkedInScriptResponse(script: any) {
  return {
    status: 'success',
    data: script,
  };
...
export function mockFetchContactDetailResponse(contact: any) {
  return {
    status: 'success',
    data: contact,
  };
...
export function mockFetchTeamMembersResponse(members: any[]) {
  return {
    status: 'success',
    data: members,
  };
...
export function mockFetchFiltersConfigResponse(config: any) {
  return {
    status: 'success',
    data: config,
  };
